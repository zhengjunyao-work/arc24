...
class cfg:
    ...
    train_dataset = '/mnt/hdd0/Kaggle/arc24/data/test_time_fine-tuning/evaluation_n-1.json'
    val_dataset = '/mnt/hdd0/Kaggle/arc24/data/arc-agi_evaluation_challenges.json'
    output_dir = '/mnt/hdd0/Kaggle/arc24/models/20240812_smaller_models_test-time_fine-tuning/03_Qwen2-1.5B-Instruct_lr1e-4_r32_3e3steps'
    max_seq_len = 4096
    epochs = 0
    max_steps : Optional[int] =  3000 #1000 # If given it will override epochs
    eval_steps = 100 #100
    warmup_ratio = 0.1
    batch_size = 16
    # SmolLM-135M-Instruct: (4, 4); Qwen/Qwen2-0.5B-Instruct: (1, 2)
...
class cfg:
    ...
    train_dataset = '/mnt/hdd0/Kaggle/arc24/data/test_time_fine-tuning/evaluation_n-1.json'
    val_dataset = '/mnt/hdd0/Kaggle/arc24/data/arc-agi_evaluation_challenges.json'
    output_dir = '/mnt/hdd0/Kaggle/arc24/models/20240812_smaller_models_test-time_fine-tuning/01_Qwen2-0.5B-Instruct_lr1e-4_r128_3e3steps'
    max_seq_len = 4096
    epochs = 0
    max_steps : Optional[int] =  3000 #1000 # If given it will override epochs
    eval_steps = 100 #100
...
class cfg:
    ...
    # train_dataset = '/mnt/hdd0/Kaggle/arc24/data/new_partitions/val_rs7_n-1_v2.json'
    train_dataset = '/mnt/hdd0/Kaggle/arc24/data/combos/combo_v2.json'
    val_dataset = '/mnt/hdd0/Kaggle/arc24/data/new_partitions/val_rs7.json'
    output_dir = '/mnt/hdd0/Kaggle/arc24/models/20240814_new_partition/11_combo-v2-from-checkpoint_Qwen2-0.5B-Instruct_lr1e-4_r32_6e3steps'
    max_seq_len = 4096
    epochs = 0
    max_steps : Optional[int] =  6000 #1000 # If given it will override epochs
    eval_steps = 100 #100
...
class cfg:
    ...
    train_dataset = '/mnt/hdd0/Kaggle/arc24/data/combos/combo_v2.json'
    val_dataset = '/mnt/hdd0/Kaggle/arc24/data/new_partitions/val_rs7.json'
    output_dir = '/mnt/hdd0/Kaggle/arc24/models/20240814_new_partition/11_combo-v2-from-checkpoint_Qwen2-0.5B-Instruct_lr1e-5_r32_1e3steps'
    max_seq_len = 4096
    epochs = 0
