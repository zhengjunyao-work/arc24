...
class CFG:
    ...
    train_dataset: str = '/mnt/hdd0/Kaggle/arc24/data/new_partitions/val_rs7_n-1.json'
    val_dataset: str = '/mnt/hdd0/Kaggle/arc24/data/new_partitions/val_rs7.json'
    output_dir: str = '/mnt/hdd0/Kaggle/arc24/models/20240820_new_partition_ttft/03_linear-lr-bs32_Qwen2-0.5B-Instruct_lr2e-5_500steps'
    max_seq_len: int = 4096
    epochs = 0
    max_steps : Optional[int] =  500 # 1000
    logging_steps: int = 5 #10
