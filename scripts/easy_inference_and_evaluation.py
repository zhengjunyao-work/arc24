...
def main(args=None):
    ...
    output_folder = os.path.dirname(args.checkpoint_path).replace('arc24/models', 'arc24/evaluations')
    output_filepath = inference(model_path, output_folder, cfg['grid_encoder'])
